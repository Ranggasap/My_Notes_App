...
public class NotesActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCreateNotesFab = findViewById(R.id.createNodeFab);
        ...
        mCreateNotesFab.setOnClickListener(this);
                            ...
                            public boolean onMenuItemClick(MenuItem item) {
                                ...
                                documentReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                                    ...
                                    public void onSuccess(Void unused) {
                                        Toast.makeText(v.getContext(), "Delete Note Success", Toast.LENGTH_SHORT).show();
                                    }
                                }).addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(v.getContext(), "Delete Note Failed", Toast.LENGTH_SHORT).show();
                                    }
                                });
